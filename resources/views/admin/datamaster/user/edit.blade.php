            ...
            <form action="{{ route('user.update', $user->id) }}" method="POST">
              ...
              <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="username" id="username" value="{{ $user->username }}" placeholder="Masukkan Username" required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <label for="new_password">Isi kolom jika ingin mengganti password, kosongkan jika tidak</label>
                    <input type="new_password" class="form-control" name="new_password" id="new_password" value="" placeholder="Masukkan Password Baru">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <select name="id_outlet" class="form-control" id="outlet">
