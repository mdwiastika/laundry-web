            ...
            <form>
              <div class="card-body">
                <div class="form-group">
                    ...
                    <input type="text" disabled value="{{ $paket->nama_paket }}" class="form-control" name="nama_paket" id="nama_paket" min="1" max="" value="{{ old('nama_paket') }}" placeholder="nama_paket" required>
                </div>
                <div class="form-group">
                    <label for="jenis">Jenis Paket</label>
                    <select name="jenis" disabled class="form-control" id="jenis">
                ...
                <div class="form-group">
                    ...
                    <input type="text" disabled class="form-control" name="harga" value="{{ $paket->harga }}" id="harga" min="1" max="" value="{{ old('harga') }}" placeholder="harga" required>
                </div>
            </div>
              <!-- /.card-body -->
